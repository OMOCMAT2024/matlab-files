...
%% Pitch/roll reduced dynamics
veh.Ktheta = 85000.0;      % pitch stiffness [N m/rad]
veh.Ctheta = 9000.0;       % pitch damping [N m s/rad]
veh.Kphi = 65000.0;        % roll stiffness [N m/rad]
veh.Cphi = 7500.0;         % roll damping [N m s/rad]
veh.dis_Kphi_ratio = 0.55;
veh.dis_Cphi_dot_ratio = 0.55;
