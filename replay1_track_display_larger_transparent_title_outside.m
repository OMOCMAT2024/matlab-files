...
insetAxPos = [0.67 0.57 0.30 0.38]; % substantially larger upper-right inset; top edge remains aligned at 0.95
...
set(ax2, 'Color', 'none', 'LineWidth', 1.0, 'Layer', 'top'); % transparent track-display background
...
hSpeedVal = text(axSpd, NaN, NaN, '', 'FontWeight', 'bold', 'Color', speedTextColor, 'BackgroundColor', [1 1 1], 'Margin', 2, 'HorizontalAlignment', 'left', 'VerticalAlignment', 'bottom', 'Clipping', 'on');
